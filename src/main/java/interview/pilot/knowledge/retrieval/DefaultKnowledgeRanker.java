...
/**
 * Default ranking: threshold filter, descending score order, near-duplicate removal and a hard
 * character budget capped at topK chunks.
 */
@Component
public class DefaultKnowledgeRanker implements KnowledgeRanker {
  @Override
